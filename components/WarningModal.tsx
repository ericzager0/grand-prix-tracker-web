      ...
      <div className="relative w-full max-w-md overflow-hidden rounded-md border border-[#1C1D24] bg-[#0E0E13] shadow-2xl">
        ...
        <div className="p-8">
          ...
          <div className="mt-8 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
            <button
              onClick={onCancel}
              className="rounded-sm border border-[#33343D] bg-transparent px-6 py-2.5 text-sm font-semibold text-[#F3F1EA] transition-colors hover:border-[#93949F] hover:bg-[#1C1D24]"
            >
              {cancelText}
            </button>
            <button
